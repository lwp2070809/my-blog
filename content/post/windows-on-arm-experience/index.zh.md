...
我没有测试过steam游戏, 根据网上看到的测评, 是可以运行很多游戏的. 由于我是Xbox用户, 并且我不想在这台电脑有限的存储空间中安装太多软件, 因此只选择Microsoft Store和Xbox PC的游戏. 在2025年8月之前, 只能在Microsoft Store安装游戏. 微软八件套z中的部分游戏如纸牌合集等是原生ARM64, 可以下载游玩. 需要注意`Minecraft Windows Edition`虽然标注了ARM, 实际上是ARM32架构, 在Windows 11 24h2彻底移除了ARM32的支持后是无法游玩的.
...
2. 由于RTC的问题导致这台电脑的实践非常不准, 我的缓解方案是使用win32tm每隔2-4小时就同步一次时间, 而非默认的7天, 并在Windows计划任务中添加一个联网即同步时间的任务, 使得电脑从睡眠中唤醒之后可以确保和真实时间一致.
